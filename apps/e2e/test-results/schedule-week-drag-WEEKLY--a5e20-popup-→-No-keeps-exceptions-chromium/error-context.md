...
- Name: schedule-week.spec.ts >> drag WEEKLY bar across days → popup → No keeps exceptions
- Location: tests/schedule-week.spec.ts:66:5
...
Call log:
  - waiting for getByTestId('week-bar-49159157-f3e8-4449-add4-d507aca25abd-2026-06-10')
